 ...
 */
/* Pixels per second. Slow enough to read a card as it goes by; the rail is
   proof, not a screensaver. */
const SPEED = 26

/* requestAnimationFrame's argument and performance.now() share a time
   origin, which is what lets the frame compare t against quietUntil. */
