    ...
    <main className={styles.main}>
      <section className={styles.header}>
        ...
        <p className={styles.sub}>
          Tell us a little about what you're working on and we'll get back to you within a day or two. Prefer to talk? <a href="https://cal.com/super-conscious/discovery-call" target="_blank" rel="noopener noreferrer" className={styles.bookLink}>Book a discovery call →</a>
        </p>
      </section>
