          ...
          <div className={styles.grid}>
            <div className={styles.card}>
              ...
              <div className={styles.cardActions}>
                ...
                <a href="/pdfs/sc-capabilities-deck.pdf" download className={styles.cardPdf}>↓ PDF</a>
              </div>
            </div>
            <div className={styles.card}>
              ...
              <div className={styles.cardActions}>
                ...
                <a href="/pdfs/sc-agency-capabilities-deck.pdf" download className={styles.cardPdf}>↓ PDF</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.grid}>
            <div className={styles.card}>
              ...
              <div className={styles.cardActions}>
                ...
                <a href="/pdfs/sc-brand-systems-deck.pdf" download className={styles.cardPdf}>↓ PDF</a>
              </div>
            </div>
            <div className={styles.card}>
              ...
              <div className={styles.cardActions}>
                ...
                <a href="/pdfs/sc-content-programs-deck.pdf" download className={styles.cardPdf}>↓ PDF</a>
              </div>
            </div>
            <div className={styles.card}>
              ...
              <div className={styles.cardActions}>
                ...
                <a href="/pdfs/sc-digital-products-deck.pdf" download className={styles.cardPdf}>↓ PDF</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.grid}>
            <div className={styles.card}>
              ...
              <div className={styles.cardActions}>
                ...
                <a href="/pdfs/sc-content-packages-deck.pdf" download className={styles.cardPdf}>↓ PDF</a>
              </div>
            </div>
          </div>
        </div>
