      ...
      <div className={styles.sections}>
        <div className={styles.callGroup}>
          ...
          <div className={styles.grid}>
            <NavLink to="/capabilities" className={styles.card}>
            ...
            <NavLink to="/agency-capabilities" className={styles.card}>
        ...
        <div className={styles.callGroup}>
          ...
          <div className={styles.grid}>
            <NavLink to="/brand-systems" className={styles.card}>
            ...
            <NavLink to="/content-programs" className={styles.card}>
            ...
            <NavLink to="/digital-products" className={styles.card}>
        ...
        <div className={styles.callGroup}>
          ...
          <div className={styles.grid}>
            <NavLink to="/content-packages" className={styles.card}>
