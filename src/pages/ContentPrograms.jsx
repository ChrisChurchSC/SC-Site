...
const CONTENT_SLUGS = new Set([
  'industry-standard', 'world-within', 'smallhold',
  'survivornet', 'spot-and-tango', 'youtube', 'path-projects',
])

const CONTENT_INTRO_SLIDES = [
  { id: 'cover', layout: 'cover' },
  {
    id: 'what-it-is', layout: 'who-we-are',
    pill: 'What it is',
    headline: 'Content that fills the channels your business lives in.',
    paragraphs: [
      "Content Programs is where brand and product become pipeline. Campaigns, channel-based creative production, and lifecycle programs: social, video, performance ads, email, editorial, lead magnets, and copy. We don't just set strategy. We produce.",
      "Every month, every channel, every format. A steady engine running in the background, generating awareness, converting interest, and keeping the customers you've earned.",
    ],
  ...
  },
  {
    ...
    when: "When you're relying on referrals and word-of-mouth and want to build a channel that doesn't depend on who you happen to know this month.",
    before: "Pipeline is lumpy. Some months are great; others are dead. There's no system generating awareness, just opportunistic moments that don't compound.",
    after: "A content and campaign engine running in the background at all times. Leads coming in from channels you built, not channels you rented. Predictable top-of-funnel activity.",
    stats: [
  ...
  {
    id: 'outcome-paid', layout: 'outcome-detail',
    pill: 'Paid performance',
    headline: 'Make paid work harder.',
    when: "When your cost per lead is rising, CTRs are declining, or your creative is stale and you're not producing enough variations to test.",
    before: "A few ad variants running for too long. CTRs declining. CPCs rising. The media team is asking for creative; there's nothing in the pipeline.",
    after: "A steady flow of fresh creative built to platform specs and optimised for performance. Paid efficiency improves because the creative is doing its job.",
    stats: [
      { metric: 'CTR', result: '+20–40% with strong creative (Nielsen)' },
      { metric: 'Cost per click', result: '15–30% reduction' },
      { metric: 'Return on ad spend', result: '+25–50%' },
    ],
  },
  {
    ...
    when: "Any time you're bringing something new to market and need to coordinate across channels without building everything from scratch in the final week.",
    before: "A rushed launch. Assets built overnight. Inconsistent messaging across channels. The product is ready; the marketing isn't. The moment passes.",
    after: "A launch that looks deliberate. Every channel says the same thing at the same time with the same quality. The moment lands.",
    stats: [
  ...
  {
    id: 'packages', layout: 'cp-packages',
    pill: 'Packages',
    packages: [
      { name: 'Nurture Engine', goal: 'Keep aware prospects engaged until ready to buy', includes: ['Social strategy', '12 static posts', '6 short-form videos', 'Campaign email series'], price: '$13,670' },
      { name: 'Always-On Demand Engine', goal: 'Continuous demand creation on a monthly cadence', includes: ['Always-on ad production', '12 static posts', 'Campaign email series', '6 short-form videos'], price: '$19,770/mo' },
      { name: 'Conversion Engine', goal: 'Turn interest into signed customers', includes: ['Landing page', 'Campaign copy', '10 static ads', 'Campaign email series'], price: '$11,495' },
      { name: 'Lead Gen Engine', goal: 'Demand-gen system that turns attention into pipeline', includes: ['Content strategy', 'Industry report', 'Landing page', 'Campaign emails', '10 static ads'], price: '$22,140' },
      { name: 'Content Authority Pack', goal: 'Build authority through owned-channel content', includes: ['Content strategy', 'Whitepaper', 'Industry report', 'Editorial newsletter', '12 static posts'], price: '$25,685' },
      { name: 'Email Acquisition System', goal: 'Lead magnet and email program to grow your owned list', includes: ['Ebook/playbook', 'Landing page', '6 emails', 'Newsletter template system', '6 short-form videos'], price: '$26,375' },
      { name: 'Retention Engine', goal: 'Keep the customers you have and grow what they spend', includes: ['Lifecycle email program', 'Customer onboarding content', 'Loyalty campaign', 'Editorial newsletter'], price: '$25,180' },
      { name: 'PLG Activation Kit', goal: 'Onboarding and lifecycle assets to activate sign-ups', includes: ['Customer onboarding content', 'Lifecycle email program', 'Interactive calculator/quiz', 'Lead magnet bundle'], price: '$27,680' },
      { name: 'PLG Expansion Engine', goal: 'Retain and expand inside existing accounts', includes: ['Loyalty/retention campaign', 'Lifecycle email program', '6 emails', 'Editorial newsletter'], price: '$22,200' },
      { name: 'Awareness Campaign', goal: "Get in front of people who don't know you yet", includes: ['Campaign concept', 'Brand film (:60-:90)', 'Industry report', '10 static ads'], price: '$54,955' },
      { name: 'ABM Sales Toolkit', goal: 'Tightly designed assets to land named accounts', includes: ['Sales deck (full)', 'Case study film', 'One-pager', '6 emails', '10 static ads'], price: '$29,805' },
      { name: 'GTM Launch Pack', goal: 'Bring a product or moment to market with one push', includes: ['Video strategy', 'Product launch film', 'Landing page', 'Campaign emails', 'Campaign launch pack'], price: '$54,350' },
    ],
    note: "All packages are fixed-scope and fixed-price. Always-On Demand Engine is quoted per month. Engagements start from $11,495.",
  },
  {
  ...
  {
    id: 'services', layout: 'cp-services',
    pill: 'Services',
    areas: [
      {
        name: 'Social',
        services: [
          { name: 'Social strategy & kickoff' },
          { name: 'Static posts — batch of 4' },
          { name: 'Static posts — batch of 8' },
          { name: 'Static posts — batch of 12' },
          { name: 'Carousels — batch of 3' },
          { name: 'Carousels — batch of 6' },
          { name: 'Illustrated posts — batch of 3' },
          { name: 'Short-form video — batch of 3' },
          { name: 'Short-form video — batch of 6' },
          { name: 'Short-form video — shoot day' },
          { name: 'Animated loops — batch of 3' },
          { name: '3D animated posts — batch of 2' },
      ...
      },
      {
        ...
        services: [
          { name: 'Video strategy & creative direction' },
          { name: 'Brand film :30' },
          { name: 'Brand film :60-:90 hero' },
          { name: 'Documentary short' },
          { name: 'Founder / customer story' },
          { name: 'Case study film' },
          { name: 'Product launch film' },
          { name: 'Ad campaign — TVC + cutdowns' },
          { name: 'Sizzle reel / explainer' },
        ],
      },
      {
        name: 'Performance Ads',
        services: [
          { name: 'Ad concept & strategy' },
          { name: 'Static ad set — batch of 5' },
          { name: 'Static ad set — batch of 10' },
          { name: 'Video ad — short' },
          { name: 'Video ad set — batch of 3' },
          { name: 'Display ad campaign' },
          { name: 'Always-on ad production' },
        ],
      },
      {
        name: 'Email & Newsletter',
        services: [
          { name: 'Email strategy & template plan' },
          { name: 'Emails — batch of 3' },
          { name: 'Emails — batch of 6' },
          { name: 'Newsletter template system' },
          { name: 'Campaign email series' },
          { name: 'Launch announcement email' },
          { name: 'Editorial newsletter design' },
        ],
      },
      {
        ...
        services: [
          ...
          { name: 'Customer onboarding content' },
          { name: 'Loyalty / retention campaign' },
        ],
      },
      {
        name: 'Editorial & Lead Magnets',
        services: [
          { name: 'Content strategy & brief' },
          { name: 'One-pager / checklist' },
          { name: 'Short guide' },
          { name: 'Ebook / playbook' },
          { name: 'Whitepaper' },
      ...
      },
      {
        ...
        services: [
          { name: 'Campaign copy' },
          { name: 'Website copy' },
          { name: 'Long-form content piece' },
          { name: 'Ad & social copy batch' },
          { name: 'Scriptwriting' },
        ],
      },
      {
        name: 'AI Content',
        services: [
          { name: 'AI-generated content batch' },
        ],
      },
    ],
  },
...
export default function ContentPrograms() {
  ...
  const clients = (data ?? [])
    ...
    .filter(p => p.tiles.length > 0 && (p.summary || p.tagline) && CONTENT_SLUGS.has(p.slug))

  const pool = clients.flatMap(c => c.tiles)

  const introSlides = CONTENT_INTRO_SLIDES.map(slide => ({ kind: 'intro', slide }))
  ...
  useEffect(() => {
    ...
    let cancelled = false
    const t = setTimeout(() => {
      if (!cancelled && printRef.current) generateDeckPdf(printRef.current, 'sc-content-programs-deck.pdf')
    }, 1500)
  ...
  useMeta({
    title: 'Content Programs | Super Conscious',
    description: 'Campaigns, creative production, and lifecycle programs that fill the channels your brand and product live in.',
...
function IntroSlide({ slide, tile }) {
  switch (slide.layout) {
    ...
    case 'outcomes':        return <CpOutcomesSlide slide={slide} />
    case 'outcome-detail':  return <CpOutcomeDetailSlide slide={slide} tile={tile} />
    case 'cp-packages':     return <CpPackagesSlide slide={slide} />
    case 'cp-services':     return <CpServicesSlide slide={slide} />
  ...
  return (
    <section className={styles.coverSlide}>
      ...
      <svg
        ...
        aria-hidden="true"
      >
        <g clipPath="url(#sc-mark-clip-content)">
        ...
        <defs>
          <clipPath id="sc-mark-clip-content">
            <rect width="42.09" height="49.24" fill="white" transform="translate(16 13)" />
          </clipPath>
        </defs>
      </svg>
      <div className={styles.coverCornerStack}>
        <div className={styles.coverCorner}>Content Programs.</div>
        <div className={styles.coverCorner}>Social, video, ads, email, editorial, and copy. The work that fills the channels.</div>
      </div>
    </section>
  )
}
...
function CpOutcomesSlide({ slide }) {
  return (
    <section className={styles.introSlide}>
      <Pill>{slide.pill}</Pill>
...
function CpPackagesSlide({ slide }) {
...
function CpServicesSlide({ slide }) {
  return (
    <section className={styles.introSlide}>
      <Pill>{slide.pill}</Pill>
      <div className={styles.cpSvcGrid}>
...
const STATIC_CATEGORY_MAP = {
  'industry-standard': [{ key: 'content', achievement: 'Launched an organic content program to grow community and drive repeat purchase.' }],
  'world-within':      [{ key: 'content', achievement: 'Developed a content program to convert awareness into community and donations.' }],
  'smallhold':         [{ key: 'content', achievement: 'Built a content engine that made Smallhold a household name in specialty produce.' }],
  'survivornet':       [{ key: 'content', achievement: 'Produced a high-volume content program to build authority in the cancer care space.' }],
  'spot-and-tango':    [{ key: 'content', achievement: 'Built a social and video content program that turned a DTC brand into a community.' }],
  'youtube':           [{ key: 'content', achievement: 'Created campaign content that drove awareness and engagement at scale.' }],
  'path-projects':     [{ key: 'content', achievement: 'Developed a content system to build community around urban exploration.' }],
}
